#python3 adadelta.py --batchsize=128 --nbepochs=1 --nbruns=1 --ntrains=25000 --lr=0.01
...
with tf.Session() as sess:
    ...
    for _ in range(nb_runs):
      ...
      loss, kl, accuracy = run_experiment(algo='adadelta', 
  	                         fake_data=fake_data, 
      ...
      adadelta_acc.append(accuracy)
    with open('losses/adadelta', 'wb') as fp: 
      pickle.dump(adadelta, fp)
    with open('losses/adadeltaacc', 'wb') as fp: 
      pickle.dump(adadelta_acc, fp)
