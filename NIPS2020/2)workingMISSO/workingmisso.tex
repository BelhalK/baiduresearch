...
We apply our new framework for inference of logistic regression model with missing covariates and for variational inference of LeNet and Resnet Bayesian variants on respectively the MNIST and CIFAR-10 datasets.
\end{abstract}
...
This application follows \textbf{Example 2} described in Section~\ref{sec:framework}. We use variational inference loss to fit Bayesian Neural Networks on different datasets.
