...
\beq
\begin{split}
\EE\big[\norm{ \tilde{S}^{(k)} - \hs{k}  }^2\big]  \leq \textcolor{red}{TO COMPLETE}
\end{split}
\eeq
\end{Lemma*}
\begin{proof}
...
\begin{split}
&\gamma_{k+1}\left(\upsilon_{\min} - \upsilon_{\max}^2  - \Lip{V} \rho\right) \rho \EE\left[\norm{\hmean_{k}}^2 \right]  + \frac{\rho^2\gamma_{k+1}^2 \Lip{V}}{2}\EE\left[\norm{ \frac{1}{n} \sum_{i=1}^n \tilde{S}_{i}^{(t_i^k)}  -  \overline{\bss}^{(k)} }^2 \right] \\
...
\beq
\begin{split}
&\sum_{k=0}^{K_{\sf max}-1} \left[  \gamma_{k+1}\rho \left(\upsilon_{\min} - \upsilon_{\max}^2  - \Lip{V} \rho\right) + \frac{\rho^2\gamma_{k+1}^2 \Lip{V}\Lip{\bss}^2\left(2 \gamma_{k+1}^2 \rho^2 + \frac{\gamma_{k+1}^2 \rho^2}{\beta}\right)}{\Lambda_{(k+1)}}\right] \EE\left[\norm{\overline{\bss}^{(k)}-\hs{k}}^2 \right] \\
...
& \leq  \EE\left[V( \hs{K_{\max}} ) - V( \hs{0} ) \right] + \sum_{k=0}^{K_{\sf max}-1}  \left[\tilde{\xi} + \rho^2\gamma_{k+1}^2 \Lip{V}\Lip{\bss}^2\frac{\gamma_{k+1}}{\Lambda_{(k+1)}}  \tilde{\epsilon}^{(k+1)} +\frac{\rho^2\gamma_{k+1}^2 \Lip{V}}{2} \EE\left[ \norm{\eta_{i_k}^{(k)}}^2\right]  \right]\\
...
\begin{split}
&\sum_{k=0}^{K_{\sf max}-1} \left[  \gamma_{k+1}\rho \left(\upsilon_{\min} - \upsilon_{\max}^2  - \Lip{V} \rho\right) + \frac{\rho^2\gamma_{k+1}^2 \Lip{V}\Lip{\bss}^2\left(2 \gamma_{k+1}^2 \rho^2 + \frac{\gamma_{k+1}^2 \rho^2}{\beta}\right)}{\Lambda_{(k+1)}}\right] \EE\left[\norm{\overline{\bss}^{(k)}-\hs{k}}^2 \right] \\
& \leq  \EE\left[V( \hs{K_{\max}} ) - V( \hs{0} ) \right] + \sum_{k=0}^{K_{\sf max}-1} \Xi^{(k+1)} +\sum_{k=0}^{K_{\sf max}-1} \Gamma_{k+1} \EE\left[ \norm{\tilde{S}^{(k)} - \hs{k}}^2\right]
\end{split}
\eeq
where 
$$
