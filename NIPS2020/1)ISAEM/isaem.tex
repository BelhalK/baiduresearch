...
& + \frac{\gamma_{k+1}^2 \Lip{V}\Lip{\bss}}{n^3} \sum_{i=1}^n \EE[ \| \hs{k} - \hs{t_i^k} \|^2 ]
\end{split}
\eeq
...
\begin{split}
& \frac{1}{n} \sum_{i=1}^n \EE[ \| \hs{k+1} - \hs{t_i^{k+1}} \|^2 ] \\
& \leq \big(\gamma_{k+1}^2 +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE \Big[  \|   \tilde{S}^{(k+1)} -  \hs{k} \|^2  \Big] + \frac{1}{n} \sum_{i=1}^n \EE \Big[  \frac{n-1}{n}(1+\gamma_{k+1} \beta) \|  \hs{k} - \hs{t_i^k} \|^2  \Big] \\
& \leq 4\big(\gamma_{k+1}^2 +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE \Big[  \|   \os^{(k)} - \hs{k}  \|^2  \Big] + 2\big(\gamma_{k+1}^2 +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE \left[\norm{ \eta_{i_k}^{(k)}}^2 \right]\\
&+  4 \big(\gamma_{k+1}^2 +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE\left[\norm{ \frac{1}{n} \sum_{i=1}^n \tilde{S}_i^{(\tau_i^k)}-  \overline{\bss}^{(k)}}^2\right] \\
&+ \frac{1}{n} \sum_{i=1}^n \EE \Big[ \big(\frac{n-1}{n}(1 + \gamma_{k+1}\beta + \frac{2\Lip{\bss}}{n^2}  \gamma_{k+1}) +\frac{2\Lip{\bss}\gamma_{k+1}^2}{n^2}  \big) \|  \hs{k} - \hs{t_i^k} \|^2  \Big]  
\end{split}
\eeq
Let us define
\beq
...
\beq
\begin{split}
 \Delta^{(k+1)} \leq & \big(\frac{n-1}{n}(1 + \gamma_{k+1}\beta + \frac{2\Lip{\bss}}{n^2}  \gamma_{k+1}) +\frac{2\Lip{\bss}\gamma_{k+1}^2}{n^2}  \big) \Delta^{(k)} +4\big(\gamma_{k+1}^2 +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE \Big[  \|   \os^{(k)} - \hs{k}  \|^2  \Big]\\
 &  + 2\big(\gamma_{k+1}^2  +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE \left[\norm{ \eta_{i_k}^{(k)}}^2 \right]+  4 \big(\gamma_{k+1}^2 +\frac{n-1}{n}\frac{\gamma_{k+1}}{\beta}  \big)\EE\left[\norm{ \frac{1}{n} \sum_{i=1}^n \tilde{S}_i^{(\tau_i^k)}-  \overline{\bss}^{(k)}}^2\right]
\end{split}
\eeq
