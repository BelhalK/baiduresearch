...
trainset = dset.MNIST(root='./data/mnist/', train=True, transform=trans, download=True)
testset = dset.MNIST(root='./data/mnist/', train=False, transform=trans, download=True)
...
optimizer     = Optadam_torch.Optadam_torch(net.parameters(), lr=args.lr, amsgrad=False, span = args.span, weight_decay = args.wd, betas = betas)    
