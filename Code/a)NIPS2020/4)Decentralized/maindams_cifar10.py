...
parser.add_argument('--num_itr_ignore', type=int, default=10,
					help='number of iterations to ignore before timing. A '
						 ...
						 'ignored')
parser.add_argument('--dataset_dir', type=str, default = '/mnt/home/weijie/imagenet/')
...
def parse_args():
	...
	if args.backend == 'mpi':
		...
		print('in mpi',args.rank,args.world_size)
	else:
		args.rank = int(os.environ['SLURM_PROCID'])
		args.world_size = int(os.environ['SLURM_NTASKS'])
		print('in else',args.rank,args.world_size)
	print(ClusterManager.CHECKPOINT_DIR)
	print(args.tag)
	print(args.rank)
