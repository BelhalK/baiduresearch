...
(kiter, Uargs, Dargs, opt, structural.model, DYF,saemixObject,indchosen,alphas)
estep.fi<-function(kiter, Uargs, Dargs, opt, structural.model, mean.phi, varList, DYF, phiM,saemixObject,l,ind_rand) {
