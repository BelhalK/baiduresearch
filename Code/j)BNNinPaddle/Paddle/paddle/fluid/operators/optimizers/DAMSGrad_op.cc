...
#include "paddle/fluid/operators/optimizers/DAMSGrad_op.h"
#include <string>
namespace paddle {
namespace operators {

class DAMSGradOp : public framework::OperatorWithKernel {
 public:
...
class DAMSGradOpInferVarType : public framework::VarTypeInference {
 public:
...
class DAMSGradOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
...
REGISTER_OPERATOR(DAMSGrad, ops::DAMSGradOp, ops::DAMSGradOpMaker,
                  paddle::framework::EmptyGradOpMaker, ops::DAMSGradOpInferVarType);
REGISTER_OP_CPU_KERNEL(DAMSGrad, ops::DAMSGradOpKernel<float>, ops::DAMSGradOpKernel<double>);
