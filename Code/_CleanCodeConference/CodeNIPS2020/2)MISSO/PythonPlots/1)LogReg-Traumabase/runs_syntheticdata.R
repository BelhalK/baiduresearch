...
# SAEM
system.time(list.saem <- miss.saem(X.obs,y,maxruns=nb.epochs,k1=0,ll_obs_cal=FALSE, algo = "saem"))
#MCEM
system.time(list.mcem <- miss.saem(X.obs,y,maxruns=nb.epochs,ll_obs_cal=FALSE, algo = "mcem"))
#Incremental MCEM
system.time(list.imcem <- miss.saem(X.obs,y,maxruns=nb.iter,ll_obs_cal=FALSE, algo = "imcem", batchsize= batchsize))
system.time(list.imcem10 <- miss.saem(X.obs,y,maxruns=N/70*nb.epochs,ll_obs_cal=FALSE, algo = "imcem", batchsize= N/10))
system.time(list.imcem50 <- miss.saem(X.obs,y,maxruns=N/350*nb.epochs,ll_obs_cal=FALSE, algo = "imcem", batchsize= N/2))
