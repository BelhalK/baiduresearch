...
def args_parser():
    ...
    parser.add_argument('--frac', type=float, default=0.1, help="Fraction of Clients used in each round: C")
    ...
    parser.add_argument('--optim', default='sgd', type=str, choices=['sgd', 'fedsketch', 'fedadam'], help='optimization algorithm')
