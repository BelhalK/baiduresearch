...
if __name__ == '__main__':
    ...
    logger = Logger('{}/log{}_opt{}_lr{}_bs{}_clients{}_frac{}.txt'.format(checkpoint_dir, logname,  args.optim, args.lr, args.local_bs,args.num_users, args.frac), title=title)
    logger.set_names(['Learning Rate', 'Avg. Loss','Train Loss','Train Acc.','Test Loss','Test Acc.'])
    ...
    for iter in range(args.epochs):
        ...
        logger.append([args.lr, loss_avg,loss_train, acc_train, loss_test, acc_test])
