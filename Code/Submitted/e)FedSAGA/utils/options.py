...
def args_parser():
    ...
    parser.add_argument('--optim', default='sgd', type=str, choices=['sgd', 'fedsketch', 'fedavg','sketchedsgd'], help='optimization algorithm')
    parser.add_argument('--sketching', default=None, type=str, choices=['privix', 'topk', 'heaprix'], help='sketching method')

    #sketching arguments
    parser.add_argument('--arraysize', type=int, default=100, help="sketches nb of rows")
    parser.add_argument('--binsize', type=int, default=200, help="sketches nb of columns")

    parser.add_argument('--topk', type=float, default=0.1, help="fraction of heavy hitters for HEAVYMIX")
