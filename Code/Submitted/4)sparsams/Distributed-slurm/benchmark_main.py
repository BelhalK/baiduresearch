...
def get_parser():
    ...
    choices=["compams", "damsgrad", "signum"])   
    
    
    #ams options
    parser.add_argument('--method', default='adapt', type=str, 
        choices=['topk','unif','tong','sign','full','QAdam'
        ,'QAdam-sign','QAdam-full','SGD','1bitAdam'], 
...
def main():
    ...
    if args.distributed:
        ...
        dist.init_process_group(backend=args.dist_backend, init_method = args.dist_url, world_size = args.world_size, rank = int(os.environ["SLURM_PROCID"]))
