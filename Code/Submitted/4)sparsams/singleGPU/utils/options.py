...
def args_parser():
    ...
    parser.add_argument('--method', default='adapt', type=str, choices=['topk','unif','tong','sign','full','QAdam','QAdam-sign','QAdam-full','SGD',
                                                                        '1bitAdam'], help='optimization algorithm')
