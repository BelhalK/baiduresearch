...
def args_parser():
    ...
    parser.add_argument('--num_users', type=int, default=50, help="Total number of clients: K")
    ...
    parser.add_argument('--local_bs', type=int, default=32, help="local mini-batch size (SGD): B")

    parser.add_argument('--LAMB', type=int, default=0, help="LAMB layer-wise adjusted lr")
    ...
    parser.add_argument('--optim', default='sgd', type=str, choices=['sgd', 'localams', 'fedavg','reddi','mime'], help='optimization algorithm')
