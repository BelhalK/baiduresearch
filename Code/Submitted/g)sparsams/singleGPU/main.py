...
# python3 main_tiny_imagenet.py --dataset tinyimagenet --iid --num_channels 1 --model resnet50 --epochs 2 --gpu -1 --method full --num_users 10 --local_ep 2
...
from models.Models import MLP, CNNMnist, CNNCifar, LeNet, LeNet_cifar, Logistic, ResNet18, ResNet9, LSTMNet, ResNet50, ResNet101
...
if __name__ == '__main__':
    ...
    if args.model == 'cnn' and args.dataset == 'cifar':
        ...
        net_glob = LeNet_cifar(args=args).to(args.device)
