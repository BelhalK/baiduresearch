...
from .localadam import LocalAdam
import collections
...
#        self.num_round = num_round
    ...
    def train(self, net , grad):
        ...
        optimizer = LocalAdam(net.parameters(), lr=self.args.lr, 
                                            betas=(self.args.momentum, self.args.beta2), 
                                            eps=1e-8, weight_decay=self.args.wdecay, amsgrad=False, 
                                            gg=grad)
