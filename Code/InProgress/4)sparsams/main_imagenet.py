#!/usr/bin/env python
# python3 main_imagenet.py --dataset mnist --iid --num_channels 1 --model cnn --epochs 2 --gpu -1 --method full --num_users 10 --local_ep 2
# python3 main_imagenet.py --dataset imagenet --iid --num_channels 1 --model resnet101 --epochs 2 --gpu -1 --method full --num_users 10 --local_ep 2 
...
from models.Models import MLP, CNNMnist, LeNet, Logistic, ResNet18, ResNet9, LSTMNet, ResNet50, ResNet101
...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        data_loader = DataLoader(imagenet_data,batch_size=4,shuffle=True, num_workers=args.nThreads)
        # pathimagenet = './data/imagenet' 
        # dataset_train, dataset_test = data_loader(pathimagenet, args.bs, args.workers, args.pin_memory)
    else:
...
#            args.lr = args.lr /10
        ...
        # if args.customarg==1 and args.dataset == 'imagenet':
        #     batch_dict = imagenet_iid(dataset_train, iter_per_epoch)
