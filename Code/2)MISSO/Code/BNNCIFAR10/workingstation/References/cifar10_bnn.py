...
DEFINE_integer("epochs",
                     default=700,
                     help="Number of epochs to train for.")
DEFINE_integer("batch_size",
                     default=128,
                     help="Batch size.")
...
DEFINE_integer("eval_freq",
                     default=400,
                     help="Frequency at which to validate the model.")
DEFINE_integer("num_monte_carlo",
                     default=50,
...
DEFINE_integer("kl_annealing",
                     default=50,
                     help="Epochs to anneal the KL term (anneals from 0 to 1)")
DEFINE_boolean("subtract_pixel_mean",
                     default=True,
