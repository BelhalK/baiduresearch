...
\begin{figure}
  \centering
  \subfloat{\includegraphics[width=0.5\textwidth]{figs/celeb1.jpg}} \\
  \subfloat{\includegraphics[width=0.5\textwidth]{figs/celeb2.jpg}}
	\caption{(Image inpainting). CelebA dataset.}
