...
As in \citep{allassonniere2015convergent}, we state the assumptions required for our analysis.
...
The complete proof is deferred in the appendix and is also developed in \citep{allassonniere2015convergent} in the context of Bayesian Mixed Effect  models trained with the EM algorithm.
