...
\begin{figure}[H]
  \centering
  \subfloat{\includegraphics[width=0.5\textwidth]{figs/celebStanley.jpg}} \\
  \subfloat{\includegraphics[width=0.5\textwidth]{figs/celebVanilla.jpg}}
...
Figure~\ref{fig:celebinpainting} shows the visual check on different samples.
