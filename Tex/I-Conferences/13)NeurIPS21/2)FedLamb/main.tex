...
\begin{figure}[t]
    ...
    \end{center}
	\caption{\textbf{Top Row}: Test accuracy on CIFAR+CNN , with iid data distribution for 10 clients 50 clients, 1 and 3 local epoch respectively. \textbf{Bottom Rown:} Test accuracy on CIFAR+ResNet with iid distribution and non-iid data distribution (\textbf{last two quadrants}) for 50 clients, 1 and 3 local epoch respectively.}
	\label{fig:cifar-cnn-iid}
\end{figure}
