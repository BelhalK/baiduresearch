...
\title{Layerwise and Dimensionwise Local Adaptive \\
...
\begin{figure}[t]
    \begin{center}
        \mbox{
        \includegraphics[width=0.32\textwidth]{figure/cifar_testerror_resnet_ep1_client10_iid1_SGD.eps}
                \includegraphics[width=0.32\textwidth]{figure/cifar_testerror_resnet_ep3_client10_iid1_SGD.eps}
        }
    \end{center}
	\caption{\textbf{From Left to Right}: Test accuracy on CIFAR+ResNet, with iid data distribution. 10 clients and 1 local epoch, 3 local epoch}
	\label{fig:cifar-cnn-iid}
\end{figure}
