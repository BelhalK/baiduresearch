...
\begin{equation}
-\eta_{t+1}\EE[\pscal{\nabla f(\theta_t)}{(\hat{V}_{t+1} + \epsilon \mathsf{I_d})^{-1/2} \bar{g}_t}] \leq \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +q^2 (1+ \frac{G^2 \eta_{t+1}}{\epsilon 2n^2})
\end{equation}
...
\end{split}
\end{equation}
Using Young's inequality with parameter equal to $1$:

\begin{equation}
\begin{split}
T_1 \leq &  \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +\frac{\eta_{t+1}}{2n^2} \EE[\|(\hat{V}_{t+1} + \epsilon \mathsf{I_d})^{-1/2} \sum_{i=1}^N  \{g_{t,i} + \tilde g_{t,i} - g_{t,i} \} \|^2]\\
& \overset{(a)}{\leq} \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +\frac{\eta_{t+1}}{2n^2} \EE[\|(\hat{V}_{t+1} + \epsilon \mathsf{I_d})^{-1/2} \|^2 \sum_{i=1}^N  \{g_{t,i} + \tilde g_{t,i} - g_{t,i} \} \|^2]\\
& \overset{(b)}{\leq} \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +\frac{\eta_{t+1}}{2n^2} \EE[\|(\hat{V}_{t+1} + \epsilon \mathsf{I_d})^{-1/2} \|^2] \EE[\| \sum_{i=1}^N  \{g_{t,i} + \tilde g_{t,i} - g_{t,i} \} \|^2]\\
& \overset{(c)}{\leq} \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +\frac{\eta_{t+1}}{\epsilon 2n^2}  \EE[\| \sum_{i=1}^N  g_{t,i}\|^2] +\frac{\eta_{t+1}}{\epsilon 2n^2}  \EE[\| \sum_{i=1}^N \tilde g_{t,i} - g_{t,i} \|^2]\\
& \overset{(d)}{\leq} \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +\frac{G^2 \eta_{t+1}}{\epsilon 2n^2} +q^2\frac{G^2 \eta_{t+1}}{\epsilon 2n^2}\\
& \leq \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +q^2 (1+ \frac{G^2 \eta_{t+1}}{\epsilon 2n^2})
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\EE[f(\theta_{t+1}) - f(\theta_{t}) ] \leq & \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +q^2 (1+ \frac{G^2 \eta_{t+1}}{\epsilon 2n^2})- \eta_{t+1} \beta_1\EE[\pscal{\nabla f(\theta_t)}{(\hat{V}_{t} + \epsilon \mathsf{I_d})^{-1/2} m_{t}}]\\
...
\begin{equation}
\begin{split}
\EE[f(\theta_{t+1}) - f(\theta_{t}) ] \leq &   (1-\beta_1) \frac{\eta_{t+1}}{2}\EE[\norm{\nabla f(\theta_t)}^2] +q^2 (1+ \frac{G^2 \eta_{t+1}}{\epsilon 2n^2}) - \eta_{t+1} \beta_1\EE[\pscal{\nabla f(\theta_t)}{(\hat{V}_{t} + \epsilon \mathsf{I_d})^{-1/2} m_{t}}]\\
& +  \left(\frac{L}{2} + \beta_1 L \right) \norm{\theta_t - \theta_{t}}^2\\
&+   \eta_{t+1} G^2 \EE[\sum_{j=1}^d \left[(\hat{v}^j_{t+1} + \epsilon )^{-1/2} - (\hat{v}^j_{t} + \epsilon )^{-1/2}  \right] ]
\end{split}
\end{equation}
