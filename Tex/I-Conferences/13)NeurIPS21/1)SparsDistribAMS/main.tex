...
d\frac{L \Delta_3}{\Delta_1 \sqrt{\maxiter}} + \frac{\Delta_2}{\eta \Delta_1\maxiter} +\frac{1-\beta_1}{\Delta_1}  (\epsilon + \frac{G^2}{1 - \beta_2})^{-\frac{1}{2}} 
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\Delta_1 & \eqdef \frac{(1-\beta_1)}{2} (\epsilon + \frac{G^2}{1 - \beta_2})^{-\frac{1}{2}} \quad \textrm{,} \quad \Delta_2 \eqdef q^2 + \sum_{k=t+1}^\infty  \beta_1^{k-t+2}\frac{G^2 }{\epsilon 2n^2}\\
...
& \leq \eta_{t+1} (1-\beta_1)  (\epsilon + \frac{G^2}{1 - \beta_2})^{-\frac{1}{2}} - f(\theta_{\maxiter})
\end{split}
\eeq
...
& + \frac{\Delta_2}{\eta \Delta_1\maxiter} +\frac{1-\beta_1}{\Delta_1}  (\epsilon + \frac{G^2}{1 - \beta_2})^{-\frac{1}{2}} 
\end{split}
\end{equation}
