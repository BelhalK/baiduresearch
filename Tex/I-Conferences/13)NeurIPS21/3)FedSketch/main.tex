...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{wrapfigure}[14]{r}{.5\linewidth}\vspace{-0.4cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{wrapfigure}[10]{r}{.6\linewidth}\vspace{-0.7cm}
\begin{minipage}{\linewidth}
\begin{algorithm}[H]
...
\begin{wrapfigure}[30]{r}{.6\linewidth}\vspace{-1.0cm}
\begin{minipage}{\linewidth}
\begin{algorithm}[H]
...
\begin{remark}
As pointed out in~\citet{horvath2020better}, while induced compressors transform a biased compressor into unbiased one, as a drawback it doubles communication cost since the devices need to send $C_1(\boldsymbol{x})$ and $C_2\left(\boldsymbol{x}-C_1\left(\boldsymbol{x}\right)\right)$ separately. 
...
\begin{wrapfigure}[32]{r}{.6\linewidth}\vspace{-1.8cm}
\begin{minipage}{\linewidth}
\begin{algorithm}[H]
...
\noindent\textbf{Comparison  with~\citet{haddadpour2020federated} and~\citet{reisizadeh2020fedpaq}}
