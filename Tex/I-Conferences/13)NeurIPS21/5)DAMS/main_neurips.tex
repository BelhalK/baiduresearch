...
%\hspace{-0.2in}
    \begin{subfigure}{0.5\textwidth}
      \includegraphics[width=0.48\textwidth]{train_loss_updated.eps}
      %\hspace{-0.1in}
      \includegraphics[width=0.48\textwidth]{test_acc_updated.eps}
      \caption{ Homogeneous data}
    \end{subfigure}
    %\hspace{-0.1in}
    \begin{subfigure}{0.5\textwidth}
      \includegraphics[width=0.48\textwidth]{ub_train_loss.eps}
      %\hspace{-0.15in}
      \includegraphics[width=0.48\textwidth]{ub_test.eps}
