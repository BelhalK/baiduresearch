...
Our algorithm is inspired by Optimistic Online learning~\citep{CJ12,RS13b,SALS15}, which assumes that, in each round of online learning, a \emph{predictable process} of the gradient of the loss function is available. 
...
\begin{wrapfigure}[10]{r}{.5\linewidth}\vspace{-0.25in}
