...
\vspace{-0.05in}
\section{Non-Asymptotic Convergence Analysis}\label{sec:analysis}
\vspace{-0.05in}
...
\begin{wrapfigure}[15]{r}{.5\linewidth}\vspace{-0.5cm}
\begin{minipage}{\linewidth}
 \algsetup{indent=1em}
\begin{algorithm}[H]
\begin{algorithmic}[1]
...
%\begin{wrapfigure}[8]{r}{.6\linewidth}\vspace{-0.2in}
%\begin{minipage}{\linewidth}
% \algsetup{indent=1em}
%\begin{algorithm}[H]
%\begin{algorithmic}[1] 
...
\end{center}
     \caption{\small (a): The iterate $w_t$; the closer to the optimal point $0$ the better. 
     (b): A scaled and clipped version of $m_t$: $w_t - w_{t-1/2}$, which measures how the prediction of $m_t$ drives the update towards the optimal point. In this scenario, the more negative the better.
     (c): Distance to the optimal point $-1$. The smaller the better. 
     (d): A scaled and clipped version of $m_t$: $w_t - w_{t-1/2}$, which measures how the prediction of $m_t$ drives
