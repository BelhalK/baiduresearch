...
\newcommand\DrawBoxxhom[3][]{%
  \begin{tikzpicture}[remember picture,overlay]
    \draw[overlay,fill=gray!30,#1] 
    ([xshift=-2.5em,yshift=-1.1ex]{pic cs:#2}) 
    rectangle 
...
\begin{figure}[H]
	\begin{center}
		...
		\includegraphics[width=0.25\textwidth]{MNIST_figures/local2_sketch20_iid0_train_loss.eps} 
		}
		...
		\includegraphics[width=0.25\textwidth]{MNIST_figures/local2_sketch50_iid0_train_loss.eps} 
		}
				\mbox{\hspace{-0.15in}		
