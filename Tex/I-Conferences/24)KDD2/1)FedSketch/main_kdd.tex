...
%\STATE {\small where ${\texttt{HP}}^{(r)}\triangleq \texttt{PRIVIX}(\mathbf{S}^{(r-1)})$}
%\vspace{0.1cm}
%%\tikzmark{a}  
%\STATE  \hspace{0.02in} \textbf{if HEAPRIX variant:} 
%{\small $$\mathbf{c}_j^{(r)}=\mathbf{c}_j^{(r-1)}-\frac{1}{\tau}\left(\texttt{HP}^{(r)}-\texttt{HP}^{(r)}_j\right)$$}
%%\tikzmark{b}
%\STATE  Set $\boldsymbol{x}^{(r)}=\boldsymbol{x}^{(r-1)}-\gamma\texttt{HP}^{(r)}$ and $\boldsymbol{x}_j^{(0,r)}=\boldsymbol{x}^{(r)}$ 
...
%\STATE  Device $j$ computes $\texttt{HP}^{(r)}_j\triangleq \texttt{HEAPRIX}[\mathbf{S}_j^{(r)}]$
...
%Then, device $j$ computes $\texttt{HP}_j\triangleq \texttt{HEAPRIX}[\mathbf{S}_j^{(r)}]$ and $  {\texttt{HP}}\triangleq \texttt{HEAPRIX}(\mathbf{S}^{(r-1)})$ and updates the correction vector $\mathbf{c}_j^{(r)}$ using the recursion $\mathbf{c}_j^{(r)}=\mathbf{c}_j^{(r-1)}-\frac{1}{\tau}\left(\texttt{HP}-\texttt{HP}_j\right)$.
%\begin{algorithm*}[t]
...
%
%\State{$\qquad\qquad$ Computes ${\texttt{HP}}^{(r)}\triangleq \texttt{PRIVIX}(\mathbf{S}^{(r-1)})$}
%
%\State{$\qquad \quad$ \textbf{if HEAPRIX variant:} }
%\State{$\qquad\qquad$ Set $\mathbf{c}_j^{(r)}=\mathbf{c}_j^{(r-1)}-\frac{1}{\tau}\left(\texttt{HP}^{(r)}-\texttt{HP}^{(r)}_j\right)$}
%\State{$\qquad\quad \quad$ Computes ${\texttt{HP}}^{(r)}\triangleq \texttt{HEAVYMIX}\left[{\mathbf{S}}^{(r-1)}\right]+\texttt{PRIVIX}\left[{\mathbf{S}}^{(r-1)}- \tilde{\mathbf{S}}^{(r-1)}\right]$}
%
%\State{$\qquad\quad$ Set $\boldsymbol{x}^{(r)}=\boldsymbol{x}^{(r-1)}-\gamma\texttt{HP}^{(r)}$ and $\boldsymbol{x}_j^{(0,r)}=\boldsymbol{x}^{(r)}$ }
...
%\State{$\qquad\quad\quad$ Device $j$ computes $\texttt{HP}^{(r)}_j\triangleq \texttt{HEAPRIX}[\mathbf{S}_j^{(r)}]$}
