...
%\hspace{-0.2in}
    \begin{subfigure}{0.5\textwidth}
      ...
      \includegraphics[width=0.45\textwidth]{train_loss_updated.eps}
      %\hspace{-0.1in}
      \includegraphics[width=0.45\textwidth]{test_acc_updated.eps}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \includegraphics[width=0.45\textwidth]{ub_train_loss.eps}
      %\hspace{-0.15in}
      \includegraphics[width=0.45\textwidth]{ub_test.eps}
