n = numel(avg_loss_adam_0001);
t = 1:5:n-1;
figure(3)
train_loss_01 = avg_every_5(avg_loss_adam_01);
train_loss_001 = avg_every_5(avg_loss_adam_001);
train_loss_0001 = avg_every_5(avg_loss_adam_0001);
train_loss_00001 = avg_every_5(avg_loss_adam_00001);
train_loss_000001 = avg_every_5(avg_loss_adam_000001);
train_loss_0000001 = avg_every_5(avg_loss_adam_0000001);
