...
\begin{figure}[H]
    \begin{center}
        \mbox{
        \hspace{-0.05in}\includegraphics[width=0.3\textwidth]{new_fmnist_mnist_fig/cifar_testerror_resnet18_ep1_client2_iid0_reddi.pdf}
        \hspace{-0.1in}\includegraphics[width=0.3\textwidth]{new_fmnist_mnist_fig/tinyimagenet_testerror_resnet18_ep1_client2_iid0_reddi.pdf}\hspace{-0.1in}
...
Our contribution is most importantly focussing on a novel method for federated learning combined with deep neural network than on the originality of the assumptions.
...
We thanks all reviewers, SPCs and ACs for their time and efforts to provide detailed and insightful comments. 
...
Reviewer #15 clearly states and admits that he/she is not familiar with the optimization field translating into a very short and superficial review where we, the authors, feel like the reviewer only expected to read keywords to make a judgement on our work (which obviously goes beyond some wording choices), see review "local minima or saddles are both excepted in this terminology".
