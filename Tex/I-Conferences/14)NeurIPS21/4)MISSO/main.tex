...
%\begin{minipage}{0.49\textwidth}\vspace{-0.3in}
%\begin{algorithm}[H]
...
\begin{figure}[t]
%\includegraphics[width=0.5\textwidth]{pic_paper/traumabasenoexp.png}\vspace{-.2cm}
\includegraphics[width=\textwidth]{pic_paper/traumabasenoexp_wallclock.png}\vspace{-.2cm}
\caption{Convergence of parameters ${\bm \delta}$ and ${\bm \beta}$ for the SAEM, the MCEM and the MISSO methods. The convergence is plotted against the wall-clock time.}\vspace{-.2cm}
...
\begin{figure}[t]
    \centering
%    \subfloat[LeNet-5 on MNIST]{{\includegraphics[width=1.35in]{pic_paper/small_lenet.png} }}%
    \subfloat[LeNet-5: MNIST]{{\includegraphics[width=2.8in]{pic_paper/lenet_vs_wallclock.png} }}%    
    \subfloat[ResNet-18: CIFAR-10]{{\includegraphics[width=2.8in]{pic_paper/resnet_vs_wallclock.png} }}%
  \caption{Negated ELBO versus time elapsed for fitting (a) Bayesian LeNet-5 on MNIST and (b) Bayesian ResNet-18 on CIFAR-10. The solid curve is obtained from averaging over 5 independent runs of the methods, and the shaded area represents the standard deviation.}\label{fig:lenetopt}
\end{figure}
%\vspace{-.4cm}
...
We provide Table~\ref{tab:runtimes}, the running times for each method on both models, exhibiting the similar runtimes of our method compared to baselines. Those values are reported in the x-axis of each plot for fair comparison. Plots against epochs elapsed are available in the supplementary material.
...
\begin{enumerate}
  \item Did you include the code, data, and instructions needed to reproduce the main experimental results (either in the supplemental material or as a URL)?
    \answerYes{See supplementary material for details on implementation.}
  \item Did you specify all the training details (e.g., data splits, hyperparameters, how they were chosen)?
    \answerYes{}
	\item Did you report error bars (e.g., with respect to the random seed after running experiments multiple times)?
    \answerYes{Results are averaged over 5 runs in the main paper and variance is plotted in the supplementary material}
	\item Did you include the total amount of compute and the type of resources used (e.g., type of GPUs, internal cluster, or cloud provider)?
    \answerYes{Running time and total compute are provided. GPUs used for our experiments are Nvidia A100 GPU cards.}
\end{enumerate}
...
\begin{center}
{\LARGE \textbf{Supplemental File \\
A doubly stochastic surrogate optimization scheme for nonconvex finite-sum problems}}
\end{center}
\vspace{0.5in}

In this supplementary file, we throughly provide the proofs for our theorems in the main paper, both the finite-time analysis and the asymptotic convergence result in Section~\ref{app:proofs}.
...
\begin{figure}[H]
    \centering
%    \subfloat[LeNet-5 on MNIST]{{\includegraphics[width=1.35in]{pic_paper/small_lenet.png} }}%
    \subfloat[LeNet-5: MNIST]{{\includegraphics[width=3.0in]{pic_paper/small_lenet.png} }}%    
    \subfloat[ResNet-18: CIFAR-10]{{\includegraphics[width=3.0in]{pic_paper/small_resnet.png} }}%
