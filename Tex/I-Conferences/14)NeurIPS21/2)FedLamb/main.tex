...
\textbf{Plan of Supplementary Material:}
...
In Figure~\ref{fig:cifar-cnn-iid-bis}, we report the test accuracies of a ResNet trained on CIFAR-10 dataset, where the data is iid allocated among clients. 
We run 1 and 3 local epochs for 10 clients and see great performances of our method.
