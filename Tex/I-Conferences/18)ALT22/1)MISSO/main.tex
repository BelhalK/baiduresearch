\documentclass[anon,12pt]{alt2022} % Anonymized submission 
...
\begin{minipage}{0.49\textwidth}\vspace{-0.43in}
\begin{algorithm}[H]
...
\includegraphics[width=0.9\textwidth]{pic_paper/traumabasenoexp_wallclock.png}\vspace{-.2cm}
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{pic_paper/lenet_vs_wallclock.png}\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{pic_paper/lenet_vs_wallclock.png}
    }
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{pic_paper/small_lenet.png}\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{pic_paper/small_resnet.png}
    }
    \end{center}
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{pic_paper/lenet_vs_wallclock.png}\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{pic_paper/small_resnet.png}
    }
    \end{center}
  \caption{Negated ELBO versus wall clock time for fitting a Bayesian LeNet-5 on MNIST. Plotted on the average of the 5 repetitions.}\label{fig:lenetopt_wallclock}
