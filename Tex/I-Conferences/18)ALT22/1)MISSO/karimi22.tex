...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{figure/logisticdelta.eps}\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{figure/logisticbeta.eps}
    }
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{figure/mnist.eps}\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{figure/cifar.eps}
    }
    \end{center}\vspace{-0.2in}
\caption{Negated ELBO versus time elapsed for fitting (Left) Bayesian LeNet-5 on MNIST and (Right) Bayesian ResNet-18 on CIFAR-10. The solid curve is obtained from averaging over 5 independent runs of the methods, and the shaded area represents the standard deviation.}\label{fig:lenetopt}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{figure/logisticdeltaepoch.eps}\hspace{-0.1in}
        \includegraphics[width=0.45\textwidth]{figure/logisticbetaepoch.eps}
    }
    \end{center}\vspace{-0.2in}
\caption{Convergence of parameters ${\bm \delta}$ and ${\bm \beta}$ for the SAEM, the MCEM and the MISSO methods. The convergence is plotted against epochs elapsed.}\vspace{-.2cm}
