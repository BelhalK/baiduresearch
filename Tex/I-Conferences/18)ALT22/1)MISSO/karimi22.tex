...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/logisticdelta.eps}\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/logisticbeta.eps}
    }
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/mnist.eps}\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/cifar.eps}
    }
    \end{center}\vspace{-0.2in}
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/logisticdeltaepoch.eps}\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/logisticbetaepoch.eps}
    }
    \end{center}\vspace{-0.2in}
\caption{Convergence of parameters ${\bm \delta}$ and ${\bm \beta}$ for the SAEM, the MCEM and the MISSO methods. The convergence is plotted against epochs elapsed.}\vspace{-.2cm}
\label{fig:misso_trauma_epochs}
\end{figure}
\vspace{-0.2in}
...
\begin{figure}[H]
    \begin{center}
    \mbox{\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/mnistepoch.eps}\hspace{-0.1in}
        \includegraphics[width=0.5\textwidth]{figure/cifarepoch.eps}
    }
    \end{center}
