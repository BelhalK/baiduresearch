...
{~\hspace{6cm}\begin{tikzpicture}[remember picture, overlay]
     \node [anchor=north east, inner sep=3cm, yshift=-4.5cm]  at (current page.north east)
     {\includegraphics[height=5cm]{images/logo_x.jpg}
     \includegraphics[height=5cm]{images/logo_inria.png}~~
      \includegraphics[height=5cm]{images/logo_warsaw.png}~~~~~~~~
