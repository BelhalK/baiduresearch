...
\newcommand{\HX}[2]{H_{\prm_{#1}} ( \SAnoise_{#2} )}
\newcommand{\PX}[1]{{P}_{\prm_{#1}}}
\newcommand{\hHX}[2]{\hat{H}_{\prm_{#1}} ( \SAnoise_{#2} )}
...
\newcommand{\erici}[1]{\todo[inline,color=red!20]{{\bf EM:} #1}}
...
\def\Zset{\mathsf{Z}}
\def\Yset{\mathsf{Y}}
\DeclareMathOperator{\Pen}{\mathcal{R}}
\def\RR{\mathbb{R}}
