...
Due to this limitation and with the sheer size of decentralized devices, the \emph{decentralized training paradigm}~\citep{duchi2011dual} is drawing attention. 
...
A common way to set $W$ for undirected graph is the Maximum-Degree Method (MDM), see~\cite{boyd2004fastest}. 
Denote $d_i$ as degree of vertex $i$ and $d_{\max} = \max_i d_i$, MDM sets $W_{i,i} = 1-d_i/d_{\max}$, $W_{i,j} = 1/d_{\max}$ if $i\neq j$ and $(i,j)$ is an edge,  and $W_{i,j} = 0$ otherwise. 
...
The detailed proofs of this section are reported inin the Appendix.

\paragraph{Proof of Theorem \ref{thm: dagm_converge}} 
...
\begin{wrapfigure}[22]{r}{0.49\textwidth}\vspace{-1.1cm}
\begin{minipage}{\linewidth}
\begin{figure}[H]
    \begin{center}
\mbox{
	\includegraphics[width=0.5\textwidth]{figures/sgd_train.eps}
	\includegraphics[width=0.5\textwidth]{figures/adam_train.eps}
        }
\mbox{
	\includegraphics[width=0.5\textwidth]{figures/amsgrad_train.eps}
         \includegraphics[width=0.5\textwidth]{figures/sgd_test.eps}
        }
\mbox{
         \includegraphics[width=0.5\textwidth]{figures/adam_test.eps}
         \includegraphics[width=0.5\textwidth]{figures/amsgrad_test.eps}
	   }
