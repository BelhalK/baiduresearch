...
However, in our decentralized setting, every node can only communicate with its neighbors and such central server does not exist, hence \cite{reddi2020adaptive} and \cite{chen2021cada} are not applicable here.
