...
It has been shown in~\cite{lian2017can} that decentralized training algorithms can outperform parameter server-based algorithms when the communication cost is the training bottleneck. 
