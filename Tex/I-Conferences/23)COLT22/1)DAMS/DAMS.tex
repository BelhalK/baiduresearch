...
%since average consensus on sparse graphs is longer.
...
\noindent \textsl{Step 1: Reparameterization.} \hspace{0.01in} Similar to~\cite{yan2018unified, chen2018convergence} with SGD (with momentum) and centralized adaptive gradient methods, define the following auxiliary sequence:
 %{\small
