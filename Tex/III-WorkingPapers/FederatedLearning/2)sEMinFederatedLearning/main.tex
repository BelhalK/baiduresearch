...
\begin{document}
\title{A Class of Stochastic EM for Federated Learning}
%\author{}
\date{\today}
...
\section{sEM methods for Federated Learning}
\begin{itemize}
\item Exact expectations
\item Incremental and variance reduced methods
\end{itemize}
