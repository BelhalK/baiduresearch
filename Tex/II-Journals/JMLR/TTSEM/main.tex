...
\author{\textbf{Belhal Karimi, Ping Li}\\\\
...
We show bot empirically and theoretically that variance reduction techniques applied to Stochastic EM type of algorithms lead to a faster convergence of the optimization phase.
