...
The Arrhythmia~\citep{Dua:2019} dataset is  obtained from the ODDS repository. The data set has 274 feature entries and 452 data samples. We use 226 samples for training  and 100 for testing. 
...
\end{tabular}
%\vspace{0.4in}
\captionof{table}{Imputation Results on Arrhythmia Dataset.} \label{tab:imp}
\end{minipage}
