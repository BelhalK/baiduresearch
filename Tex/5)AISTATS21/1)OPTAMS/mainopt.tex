...
There exists a constant $a \in \rset $ such that for any $t >0$, $0 < \pscal{m_t}{ g_t}  \leq a \|g_t\|^2$.
\end{assumption}
...
\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{simulation/fig2/cifar_cnn_train_loss_no1.eps}\hspace{-0.1in}
\includegraphics[width=1.8in]{simulation/fig2/imdb_lstm_train_loss_no1.eps}
}
...
\begin{figure}[H]
\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{new_figure/new_mnist_img_figure/mnist_img_train_loss_disz_2.eps}\hspace{-0.12in}
\includegraphics[width=1.8in]{new_figure/new_mnist_img_figure/mnist_img_train_acc_disz_2.eps}\hspace{-0.12in}
}

\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{new_figure/mnist_img_test_loss_disz.eps}\hspace{-0.12in}
\includegraphics[width=1.8in]{new_figure/mnist_img_test_acc_disz.eps}
}

\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{new_figure/cifar10_train_loss_disz.eps}\hspace{-0.12in}
\includegraphics[width=1.8in]{new_figure/cifar10_train_acc_disz.eps}\hspace{-0.12in}
}
\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{new_figure/cifar10_test_loss_disz.eps}\hspace{-0.12in}
\includegraphics[width=1.8in]{new_figure/cifar10_test_acc_disz.eps}
}
\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{new_figure/cifar100_train_loss_disz.eps}\hspace{-0.12in}
\includegraphics[width=1.8in]{new_figure/cifar100_train_acc_disz.eps}\hspace{-0.12in}
}
\mbox{\hspace{-0.2in}
\includegraphics[width=1.8in]{new_figure/cifar100_test_loss_disz.eps}\hspace{-0.12in}
\includegraphics[width=1.8in]{new_figure/cifar100_test_acc_disz.eps}
}
\vspace{-0.15in}
