...
The goal of VI is to minimized the distance, in terms of Kullback-Leibler (KL), between the variational candidate and the true posterior, noted $\text{KL}(q_\phi(\mathbf{z}|\mathbf{x})||p_\theta(\mathbf{z}|\mathbf{x}) )$.
