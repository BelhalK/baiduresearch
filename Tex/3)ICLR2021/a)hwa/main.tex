...
\begin{figure}[H]
\mbox{
\includegraphics[width=0.5\textwidth]{figs/trainhwamnist_blenet.png}
\includegraphics[width=0.5\textwidth]{figs/testhwamnist_blenet.png}
}
\mbox{
...
\includegraphics[width=0.5\textwidth]{figs/testhwacifar_bvgg.png}
	...
	\caption{Comparison for Bayesian LeNet CNN architecture on MNIST dataset (top) and Bayesian VGG architecture on CIFAR-10 dataset (bottom).}
    \label{fig:mnist}
\end{figure}
