...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
\noindent\footnote{The work of Xiangyi Chen was conducted while he was a Research Intern at Baidu Research  in Summer 2019.}Adaptive gradient methods including Adam, AdaGrad, and their variants have been very successful for training deep learning models, such as neural networks. 
...
\begin{center}
\mbox{
    \begin{subfigure}[b]{5.4in}
    \mbox{
      \includegraphics[width=2.7in]{figures/train_loss_updated_wj.eps}%\hspace{-0.12in}
            \includegraphics[width=2.7in]{figures/test_acc_updated_wj.eps}
            }
...
\mbox{
    \begin{subfigure}[b]{5.4in}
    \mbox{
      \includegraphics[width=2.7in]{figures/ub_train_loss_wj.eps}%\hspace{-0.12in}
            \includegraphics[width=2.7in]{figures/ub_test_wj.eps}
            }
...
% \begin{wrapfigure}[25]{r}{.27\linewidth}
...
\centering
\mbox{
\begin{subfigure}[b]{2.7in}
		\includegraphics[width=\textwidth]{figures/sgd_train_wj.eps}
      \caption{ D-PSGD loss}
    \end{subfigure}
    \begin{subfigure}[b]{2.7in}
		\includegraphics[width=\textwidth]{figures/amsgrad_train_wj.eps}
...
\mbox{    
        \begin{subfigure}[b]{2.7in}
		\includegraphics[width=\textwidth]{figures/adam_train_wj.eps}
      \caption{Decentralized Adam loss}
    \end{subfigure}
 
    \begin{subfigure}[b]{2.7in}
		\includegraphics[width=\textwidth]{figures/sgd_test_wj.eps}
...
\mbox{
    \begin{subfigure}[b]{2.7in}
		\includegraphics[width=\textwidth]{figures/amsgrad_test_wj.eps}
      \caption{Decentralized AMS accuracy}
    \end{subfigure}
        \begin{subfigure}[b]{2.7in}
		\includegraphics[width=\textwidth]{figures/adam_test_wj.eps}
...
%	\centering
%	\includegraphics[width=0.8\textwidth]{figures/sgd_trainnew.eps}
%	\caption{\small Training loss}
%	\end{subfigure}
%\begin{subfigure}{.45\textwidth}
%	\centering
%		\includegraphics[width=0.8\textwidth]{figures/sgd_testnew.eps}
...
%	\begin{subfigure}{.45\textwidth}
%	\centering
%	\includegraphics[width=0.8\textwidth]{figures/amsgrad_trainnew.eps}
%	\caption{\small Training loss}
%	\end{subfigure}
%\begin{subfigure}{.45\textwidth}
%	\centering
%		\includegraphics[width=0.8\textwidth]{figures/amsgrad_testnew.eps}
%	\caption{\small  Test accuracy}
%	\end{subfigure}
...
%	\begin{subfigure}{.45\textwidth}
%	\centering
%	\includegraphics[width=0.8\textwidth]{figures/adam_trainnew.eps}
%	\caption{\small Training loss}
%	\end{subfigure}
%\begin{subfigure}{.45\textwidth}
%	\centering
%		\includegraphics[width=0.8\textwidth]{figures/adam_testnew.eps}
%	\caption{\small  Test accuracy}
%	\end{subfigure}
