...
\begin{subfigure}[b]{0.3\textwidth}
    \mbox{
		\includegraphics[width=\textwidth]{figures/sgd_trainnew.eps}
            }
      \caption{ D-PSGD loss}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
    \mbox{
		\includegraphics[width=\textwidth]{figures/amsgrad_trainnew.eps}
            }
      \caption{Decentralized AMS loss}
    \end{subfigure}
        \begin{subfigure}[b]{0.3\textwidth}
    \mbox{
		\includegraphics[width=\textwidth]{figures/adam_trainnew.eps}
            }
    ...
    \begin{subfigure}[b]{0.3\textwidth}
    \mbox{
		\includegraphics[width=\textwidth]{figures/sgd_testnew.eps}
            }
      \caption{ D-PSGD accuracy}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
    \mbox{
		\includegraphics[width=\textwidth]{figures/amsgrad_testnew.eps}
            }
      \caption{Decentralized AMS accuracy}
    \end{subfigure}
        \begin{subfigure}[b]{0.3\textwidth}
    \mbox{
		\includegraphics[width=\textwidth]{figures/adam_testnew.eps}
            }
