...
\begin{figure}[H]
	...
	\textbf{First Middle Row:} Test accuracy on CIFAR+ResNet with iid data distribution for 50 clients 1 and 3 local epochs respectively.
	\textbf{Second Middle Row:} Test accuracy on CIFAR+CNN with iid data distribution for 50 clients 1 and 3 local epochs respectively.
	\textbf{Bottom Row:} Test accuracy on CIFAR+ResNet with non iid data distribution for 50 clients and 3 local epochs.}
