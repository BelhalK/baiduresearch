...
\{belhal.karimi, lixiaoyun996, pingli98\}@gmail.com}
...
In~\cite{chen2020toward}, the authors motivate the use of adaptive gradient optimization methods as a better alternative to the standard SGD inner loop in Fed-Avg.
...
\begin{figure}[H]
    \begin{center}
        \mbox{
        \includegraphics[width=0.33\textwidth]{figure/cifar_testerror_resnet_ep1_client10_iid1_SGD.eps}
         \includegraphics[width=0.33\textwidth]{figure/cifar_testerror_resnet_ep3_client10_iid1_SGD.eps}
                   \includegraphics[width=0.33\textwidth]{figure/cifar_testerror_resnet_ep1_client50_iid1_SGD.eps}
        }
                \mbox{
                        \includegraphics[width=0.33\textwidth]{figure/cifar_testerror_resnet_ep3_client50_iid1_SGD.eps}
                                \includegraphics[width=0.33\textwidth]{figure/cifar_testerror_cnn_ep1_client50_iid1.eps}
        \includegraphics[width=0.33\textwidth]{figure/cifar_testerror_cnn_ep3_client50_iid1.eps}
