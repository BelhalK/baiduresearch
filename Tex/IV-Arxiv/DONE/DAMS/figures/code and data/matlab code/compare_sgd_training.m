n = numel(avg_loss_sgd_001);
t = 1:5:n-1;
figure(8)
train_loss_01 = avg_every_5(avg_loss_sgd_01);
train_loss_001 = avg_every_5(avg_loss_sgd_001);
train_loss_0001 = avg_every_5(avg_loss_sgd_0001);
train_loss_00001 = avg_every_5(avg_loss_sgd_00001);
train_loss_000001 = avg_every_5(avg_loss_sgd_000001);
train_loss_0000001 = avg_every_5(avg_loss_sgd_0000001);
