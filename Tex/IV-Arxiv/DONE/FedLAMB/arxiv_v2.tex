...
\title{\bf \textsc{Fed-LAMB}: Layer-wise and Dimension-wise Locally Adaptive Optimization}
...
We now discuss the similarities and differences between Fed-AMS, the baseline distributed adaptive method developed in~\citet{chen2020toward}, and our \algo. For clarity, we restate their main result under our notations:
