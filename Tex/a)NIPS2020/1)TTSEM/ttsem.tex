...
We will explicit a general update that will cover those variants and that represents the \textit{second level} of our algorithm, namely the incremental update of the approximated statistics $\hat{S}^{(k)}$ inside the RM type of update.
...
\begin{wrapfigure}[14]{r}{.5\textwidth}\vspace{-.5cm}
