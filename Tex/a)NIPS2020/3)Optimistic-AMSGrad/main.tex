...
\end{align*}
\end{Theorem}
We remark that the bound for our OPT-AMSGrad method matches the complexity bound of $\mathcal{O}\left( \sqrt{d/T_{\sf M}} + 1/T_{\sf M} \right)$ of \citep{ghadimi2013stochastic} for SGD and \citep{ZTYCG18} for AMSGrad method.
