...
\mbox{
\subfigure{
\includegraphics[width=0.25\textwidth]{simulation/fig2/M_rand_train_loss_no1.eps}\hspace{-0.15in}
}
%\subfigure{
%\includegraphics[width=1.4in]{simulation/fig2/M_image_train_loss_no1.eps}\hspace{-0.15in}
%}
\subfigure{
\includegraphics[width=0.25\textwidth]{simulation/fig2/cifar_cnn_train_loss_no1.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=0.25\textwidth]{simulation/fig2/imdb_lstm_train_loss_no1.eps}\hspace{-0.15in}
}
%\subfigure{
%\includegraphics[width=1.2in]{simulation/fig2/cifar10_resnet_train_loss.eps}\hspace{-0.15in}
%}
\subfigure{
\includegraphics[width=0.25\textwidth]{simulation/fig2/cifar100_resnet_train_loss.eps}\hspace{-0.15in}
}
}
...
\mbox{
\subfigure{
\includegraphics[width=1.4in]{new_figure/new_mnist_img_figure/mnist_img_train_loss_disz_2.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/new_mnist_img_figure/mnist_img_train_acc_disz_2.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/mnist_img_test_loss_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/mnist_img_test_acc_disz.eps}\hspace{-0.15in}
}
}\vspace{-0.15in}
\mbox{
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar10_train_loss_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar10_train_acc_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar10_test_loss_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar10_test_acc_disz.eps}\hspace{-0.15in}
}
}\vspace{-0.15in}
\mbox{
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar100_train_loss_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar100_train_acc_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar100_train_loss_disz.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.4in]{new_figure/cifar100_test_acc_disz.eps}
}
}
...
\begin{wrapfigure}[12]{r}{1.7in}\vspace{-0.3in}
\begin{center}
\mbox{
...
\mbox{
\subfigure{
\includegraphics[width=1.8in]{simulation/fig2/M_rand_train_loss_no1.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.8in]{simulation/fig2/M_image_train_loss_no1.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.8in]{simulation/fig2/cifar_cnn_train_loss_no1.eps}\hspace{-0.15in}
}
}
\mbox{
\subfigure{
\includegraphics[width=1.8in]{simulation/fig2/imdb_lstm_train_loss_no1.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.8in]{simulation/fig2/cifar10_resnet_train_loss.eps}\hspace{-0.15in}
}
\subfigure{
\includegraphics[width=1.8in]{simulation/fig2/cifar100_resnet_train_loss.eps}\hspace{-0.15in}
}
}
\caption{Training loss vs. Number of iterations for fully connected NN, LSTM, CNN and ResNet.}
