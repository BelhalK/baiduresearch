...
\begin{figure}[H]
    \mbox{\hspace{-0.2in}
    \subfigure[]{
    \includegraphics[width=0.5\textwidth]{simulation/fig/fig1_left.eps}
    }
    \subfigure[]{
    \includegraphics[width=0.5\textwidth]{simulation/fig/fig1_right.eps}
    }
    }
    \mbox{\hspace{-0.2in}
    \subfigure[]{
    \includegraphics[width=0.5\textwidth]{simulation/fig/fig2_left.eps}
    }
        \subfigure[]{
    \includegraphics[width=0.5\textwidth]{simulation/fig/fig2_right.eps}
    }
    }
