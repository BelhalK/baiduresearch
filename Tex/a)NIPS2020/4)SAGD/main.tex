...
Due to space limit, most of the proofs are deferred to Supplementary Material.
...
At each iteration $t$, Algorithm~\ref{algo: mini-StAda} uses any \textsc{DPG} procedure to compute a differential private gradient $\tilde \g_t$ on each batch and update $\w_t$. \vspace{-0.05in}
\begin{algorithm}[H] 
