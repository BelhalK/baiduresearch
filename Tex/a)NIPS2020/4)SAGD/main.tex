...
%Note that the partitioning of data here is conceptual and the way of data pass does not change from \textsc{SAGD} in implementation. However, the performance can be improved by leveraging $m$. 
...
%Note that the total number of parameter updates in mini-batch \textsc{SAGD} is $TB$. 
\begin{algorithm}[H] 
