...
In particular,~\citet{rara2017, mowa2018, lilu2019, pejo2018} focus on noisy gradient algorithms, e.g., \textsc{SGLD}, and provide a generalization bound in $\mathcal{O}(\sqrt{T}/n)$. 
...
%\includegraphics[width = 0.52 \textwidth ]{figure/mnist_relu.png}
\includegraphics[width = 0.48 \textwidth ]{figure/new/relu.png}
}
\subfigure[MNIST, 2-layer Sigmoid]{
%\includegraphics[width = 0.52 \textwidth]{figure/mnist_sigmoid.png}
\includegraphics[width = 0.48 \textwidth ]{figure/new/sigmoid.png}
 }
 }
...
\includegraphics[width = 0.48 \textwidth ]{figure/new/resnet.png}
}
\subfigure[CIFAR10, VGG-19]{
%\includegraphics[width = 0.52 \textwidth]{figure/cifar10_vgg.png}
\includegraphics[width = 0.48 \textwidth ]{figure/new/vgg.png}
 }
 }
 \vspace{-0.1in}
...
Particularly,~\citet{wiro17} highlight that the initial stepsize and the scheme of decaying stepsizes have a considerable impact on the performance. 
...
\includegraphics[width = 0.48 \textwidth ]{figure/new/2lstm.png}
}
\subfigure[Penn Treebank, 3-Layer LSTM]{
%\includegraphics[width = 0.52 \textwidth]{figure/ptb_3lstm.png}
\includegraphics[width = 0.48 \textwidth ]{figure/new/3lstm.png}
 }
}
 \vspace{-0.1in}
