...
\beq\notag
\EE \left[ \underset{f \in \mathcal{F}}{\sup}\left|X_{f}-X_{0}\right|\right] \leq \frac{1}{\sqrt{M}} \int_{0}^{1} \sqrt{\log \mathcal{N}\left(\mathcal{F},\|\cdot\|_{\infty}, \varepsilon\right)} d \varepsilon\eqsp,
\eeq
