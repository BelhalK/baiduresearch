...
\begin{minipage}{0.5\textwidth}\vspace{-0.12in}
\begin{algorithm}[H]
...
The MISO method is an incremental version of the MM method, as summarized by \Cref{alg:miso}, which shows that the MISO method maintains an iteratively updated set of surrogate upper-bound functions $\{ \tafctdet{i}{k}{\param} \}_{i=1}^n$ and updates the iterate via minimizing the average of the surrogate~functions.
