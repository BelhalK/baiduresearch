...
In \citep[Theorem 8.2.3]{vershynin2018high}, the authors recall the uniform law of large numbers by stating that for $(z_{i,m}, i \in \llbracket 1, M \rrbracket)$ random variables in $(0,1)$, we have, for a class of $L$-Lipschitz functions:
