...
\textbf{Start of the Proof:} Having established those two auxiliary results, we now give a sketch of the proof for Theorem~\ref{thm:isaem}.
...
An equivalent update of Line~\eqref{eq:fisaem} is given in the following for the purpose of the proof.
