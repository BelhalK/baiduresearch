...
There exists a constant $a \in \rset $ such that for any $t >0$, $0 < \pscal{m_t}{ g_t}  \leq a \|g_t\|^2$, where $\pscal{}{}$ is the inner product notation.
\end{assumption}
...
\beq \notag
\begin{split}
&\tilde{C}_{1,t} = C_{1,t} +  \frac{\major}{(1 - a_t\beta_1) + (\beta_1 + a_t)} \left[ \frac{a(1 - \beta_1)^2}{1-\beta_2} + 2L \frac{1}{1-\beta_2}  \right] \eqsp, \\
