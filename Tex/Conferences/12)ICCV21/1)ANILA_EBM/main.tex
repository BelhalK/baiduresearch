...
Beforehand, we state an intermediary Lemma that will be useful throughout the proof.
...
\end{lemm}
Lemma~\ref{lem:cone} establishes a relation between the set of accepted state noted $\accept(z)$ and the cone $\mathcal{P}(z)$ designed so that it does not depend on the model parameter $\theta$. 




The complete proof of Theorem~\ref{thm:thm1} as well as the proof of Lemma~\ref{lem:cone} can be found in the supplementary material of this paper.
