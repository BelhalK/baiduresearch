...
We also consider the case of a short-run MCMC for the training of an Energy-Based model.
...
out-of-distribution detection \cite{ebmood2020}, inverse optimal control \cite{xu2019energy}, deep regression~\cite{gustafsson2020energy} and reinforcement learning \cite{haarnoja2018soft}.
