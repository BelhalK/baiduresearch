...
{\color{blue}The bounds in Theorem~\ref{thm:homog_case} suggests that in homogeneous setting if we set $d=m$ (no compression), the number of communication rounds to archive the $\epsilon$ error matches with the number of iteration required to achieve the same error under a centralized setting. 
