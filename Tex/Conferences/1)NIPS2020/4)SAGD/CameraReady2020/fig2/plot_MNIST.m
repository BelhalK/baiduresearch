...
folder = 'MNIST/RELU/';textbody = 'MNSIT: ReLU';
%folder = 'MNIST/SIGMOID/';textbody = 'MNSIT: Sigmoid';

x = [200, 500, 1000, 2000, 5000, 10000, 20000,50000];
...
text(125,0.2,textbody,'fontsize',20,'color','r','fontweight','bold');
