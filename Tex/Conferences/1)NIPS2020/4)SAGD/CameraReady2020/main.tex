...
% \begin{wrapfigure}[30]{r}{3.0in}\vspace{-0.3in}
% \begin{center}
% \mbox{
% \subfigure[Penn Treebank, 2-Layer LSTM]{
% \includegraphics[width = 0.53 \textwidth ]{figure/new/2lstm2.png}
% }
% }
% \vspace{-0.05in}
% \mbox{
% \subfigure[Penn Treebank, 3-Layer LSTM]{
% \includegraphics[width = 0.53 \textwidth ]{figure/new/3lstm2.png}
% }
% }
% \vspace{-0.05in}
% \mbox{
% \subfigure[SNLI, bidirectional LSTM]{
% \includegraphics[width = 0.26 \textwidth ]{figure/new/bilstmtrainwithlap.png}
% \includegraphics[width = 0.26 \textwidth ]{figure/new/bilstmtestwithlap.png}
% }
% }
% \end{center}
% \vspace{-0.1in}
%  \caption[]{2-layer LSTM, 3-layer LSTM and biLSTM. 
% Adaptive methods achieves better training performance, yet \textsc{SAGD} achieves the best test perplexity.
% } 
...
We use $300$ dimensions as fixed word embeddings and set the learning rate following the method described above.
 \begin{wrapfigure}[14]{r}{3.0in}\vspace{-0.2in}
 \begin{center}
 \mbox{
 \subfigure[SNLI, bidirectional LSTM]{
 \includegraphics[width = 0.26 \textwidth ]{figure/new/bilstmtrainwithlap.png}
