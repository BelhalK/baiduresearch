...
In particular,~\citep{rara2017, mowa2018, lilu2019, pejo2018} focus on noisy gradient algorithms, e.g., \textsc{SGLD}, and provide a generalization bound in $\mathcal{O}(\sqrt{T}/n)$. 
...
\includegraphics[width = 0.50 \textwidth]{figure/new/sigmoid2.png}
 }
 }
...
\hspace{-0.15in}
\includegraphics[width = 0.50 \textwidth]{figure/new/resnet2.png}
}
\hspace{-0.1in}
\subfigure[CIFAR10, VGG-19]{
\includegraphics[width = 0.50 \textwidth]{figure/new/vgg2.png}
 }
 }
...
% \begin{wrapfigure}[30]{r}{2.5in}\vspace{-0.3in}
% \begin{center}
% \mbox{
% \subfigure[Penn Treebank, 2-Layer LSTM]{
% \includegraphics[width = 0.48 \textwidth ]{figure/new/2lstm2.png}
% }
% }
% \mbox{
...
% }
% \mbox{
% \subfigure[SNLI, bidirectional LSTM]{
% \includegraphics[width = 0.24 \textwidth ]{figure/new/bilstmtrainwithlap.png}
% \includegraphics[width = 0.24 \textwidth ]{figure/new/bilstmtestwithlap.png}
% }
% }
% \end{center}
% \vspace{-0.1in}
%  \caption[]{2-layer LSTM, 3-layer LSTM and biLSTM. 
% Adaptive methods achieves better training performance, yet \textsc{SAGD} performs the best in terms of the test perplexity.
% } 

% \label{fig:cifar10}%\vspace{0.3in}
% \end{wrapfigure}
...
\begin{figure}[H] 
 \mbox{
%\includegraphics[width = 0.48 \textwidth ]{figure/new/bilstmtrain.png}
%\includegraphics[width = 0.48 \textwidth ]{figure/new/bilstmtest.png}
