...
\begin{figure}[h]
    \begin{center}
    \mbox{\hspace{-0.3in}
        \includegraphics[width=1.7in]{figure/mnist_cnn_test_accuracy.eps}
        \includegraphics[width=1.7in]{figure/cifar_cnn_test_accuracy.eps}
        \includegraphics[width=1.7in]{figure/cifar_lenet_test_accuracy.eps}
    }
    \end{center}
    \vspace{-0.1in}
