...
\begin{itemize}
    \item We provide a new algorithm -- \texttt{HEAPRIX} -- and theoretically show that it reduces the cost of communication between devices and server, which is based on unbiased sketching without requiring the broadcast to the server of exact values of gradients. 
...
Thus, sketching-based server-devices communication algorithms such as ours also keeps the inputs private as a by-product.
...
We are adding in this section, numerical runs for an intermediary number of local updates $\tau =2$ and confirm for both cases the trend we observe in the plots of the main text regarding increasing this number.
...
\begin{figure}[H]
	\begin{center}
		\mbox{\hspace{-0.15in}			  
		 \includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch20_iid1_train_loss.eps} \hspace{-0.12in}
		 \includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch20_iid1_test_acc.eps} 
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch20_iid1_train_loss.eps}\hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch20_iid1_test_acc.eps}
		}
		\mbox{\hspace{-0.15in}	
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch50_iid1_train_loss.eps} \hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch50_iid1_test_acc.eps} 
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch50_iid1_train_loss.eps}\hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch50_iid1_test_acc.eps}
		}
	\end{center}
	\vspace{-0.1in}
	\caption{CIFAR10 Homogeneous case: Comparison of compressed optimization methods on LeNet CNN.}
    \label{fig:CIFAR-iid1}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\mbox{\hspace{-0.15in}			   
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch20_iid0_train_loss.eps} \hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch20_iid0_test_acc.eps} 
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch20_iid0_train_loss.eps} \hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch20_iid0_test_acc.eps}
		}
		\mbox{\hspace{-0.15in}	
		 \includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch50_iid0_train_loss.eps} \hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local1_sketch50_iid0_test_acc.eps} 
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch50_iid0_train_loss.eps}\hspace{-0.12in}
		\includegraphics[width=1.7in]{CIFAR_figures/cifar_local5_sketch50_iid0_test_acc.eps}
		}
	\end{center}
	\vspace{-0.1in}
	\caption{CIFAR10 Heterogeneous case: Comparison of compressed optimization algorithms on LeNet CNN.}
    \label{fig:CIFAR-iid0}
\end{figure}
