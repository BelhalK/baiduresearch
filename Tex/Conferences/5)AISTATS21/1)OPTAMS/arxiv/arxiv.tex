...
\includegraphics[width=2.1in]{new_figure/mnist_img_test_loss_disz.eps}
}
...
\includegraphics[width=2.1in]{new_figure/cifar10_train_acc_disz.eps}
}
...
\includegraphics[width=2.1in]{new_figure/cifar100_train_loss_disz.eps}
}
\mbox{%\hspace{-0.1in}
