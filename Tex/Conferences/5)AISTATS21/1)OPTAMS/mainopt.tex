...
\aistatstitle{\vspace{-0.05in}An Optimistic Acceleration of AMSGrad for Nonconvex Optimization\vspace{-0.05in}}
...
\begin{figure}[h]
\mbox{\hspace{-0.15in}
\includegraphics[width=1.8in]{new_figure/new_mnist_img_figure/mnist_img_train_loss_r3510_2.eps}\hspace{-0.1in}
\includegraphics[width=1.8in]{new_figure/cifar10_train_loss_r3510.eps}
}
\vspace{-0.2in}
\caption{Training loss w.r.t. different $r$ values.}\label{fig:compare}%\vspace{-0.05in}
\end{figure}
