...
Invertible functions are employed to connect the studied graph nodes as in flow-based models~\citep{Dinh2016DensityEU} to achieve tractable message passing. 
...
The proposed Variational Flow Graphical models provide approaches to integrate multi-modal data or data sets from different sources. With invertible flow functions, we analyze the identifiability~\citep{Khemakhem20a,Sorrenson2020} of the VFG in this subsection.  
