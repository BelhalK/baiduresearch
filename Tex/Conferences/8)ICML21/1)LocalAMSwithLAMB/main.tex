...
We have introduced the vanilla AMSGrad method in Algorithm~\ref{alg:amsgrad}


\subsection{Layerwise and Dimensionwise Learning with Periodic Averaging}
In this section, we will recall our problem setting and introduce our novel method for performing efficient federated learning among large amount of devices.
