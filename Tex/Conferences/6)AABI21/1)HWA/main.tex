...
Numerical runs show the advantage of our method matching and sometimes beating SOTA methods such as SGLD or CSGMCMC, which requires additional expensive gradient computation.
